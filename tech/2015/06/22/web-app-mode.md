...
<!-- Swipe Instructions End -->
          ...
          <h4>
            ...
            <small>
              ...
              <a href="/tech/2015/06/22/web-app-mode.md#disqus_thread">Comments</a>
              <br />
...
<div>
  <ul class="rrssb-buttons clearfix">
      ...
      <li class="rrssb-email">
        <a href="mailto:?subject=Web app mode&body=https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md" data-proofer-ignore>
      ...
      <li class="rrssb-facebook">
        <a href="https://www.facebook.com/sharer/sharer.php?u=https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md&title=Web app mode" class="popup">
          <span class="rrssb-icon">
      ...
      <li class="rrssb-twitter">
        <a href="https://twitter.com/share?url=https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md&text=Web app mode"
        class="popup">
      ...
      <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md" class="popup">
        <span class="rrssb-icon">
          <svg xmlns="https://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
      ...
      <li class="rrssb-reddit">
        <a href="https://www.reddit.com/submit?url=https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md&title=Web app mode" target="_blank">
          <span class="rrssb-icon">
            <svg xmlns="https://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
      ...
      <li class="rrssb-googleplus">
        <a href="https://plus.google.com/share?url=https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md" class="popup">
          <span class="rrssb-icon">
      ...
      <li class="rrssb-tumblr">
        <a href="https://tumblr.com/share/link?url=https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md" target="_blank">
          <span class="rrssb-icon">
            <svg xmlns="https://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
      ...
      <li class="rrssb-pinterest">
        <a href="https://pinterest.com/pin/create/button/?url=https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md" target="_blank">
          <span class="rrssb-icon">
            <svg xmlns="https://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
      ...
      <li class="rrssb-pocket">
        <a href="https://getpocket.com/save?url=https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md">
          <span class="rrssb-icon">
      ...
      <li class="rrssb-vk">
        <a href="https://vk.com/share.php?url=https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md" class="popup">
          <span class="rrssb-icon">
...
function addTohistory() {
  if (!window.location.host.startsWith("127.0.0.1")) {
    history.pushState({}, 'Web app mode', 'https://z3nth10n.github.io/tech/2015/06/22/web-app-mode.md');
  }
}
</script>
