...
<script>
    ...
    $(document).ready(function() {
      ...
      $(".timeline.only-button button").on('click', readMoreItems);
        
      
        
      function readMoreItems() {
          var curHeight = $(".timeline.expandable").height(),
              sumHeight = 0,
              count = 0,
          ...
          $(".timeline.expandable li").each(function(i) {
              ...
              var localHeight = $(this).outerHeight(true);
              // console.log("At index: " + i + " => " + localHeight);
          ...
          $(".timeline.expandable").height(curHeight + sumHeight + "px"); // Bug: I need to show 100px less
      }
